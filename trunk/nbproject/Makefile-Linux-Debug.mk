...
${OBJECTDIR}/src/TObject.o: src/TObject.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.cc) -g -D_DEBUG -Iinclude -Ideps/bullet/src -Ideps/irrlicht/include -Isource/irrlicht -Ideps/irrklang/include -Itools/lsl/include -Itools/lsl/src/lua -Ideps/irrlicht/source/Irrlicht -o ${OBJECTDIR}/src/TObject.o src/TObject.cpp
...
${OBJECTDIR}/src/TGUISkin2.o: src/TGUISkin2.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.cc) -g -D_DEBUG -Iinclude -Ideps/bullet/src -Ideps/irrlicht/include -Isource/irrlicht -Ideps/irrklang/include -Itools/lsl/include -Itools/lsl/src/lua -Ideps/irrlicht/source/Irrlicht -o ${OBJECTDIR}/src/TGUISkin2.o src/TGUISkin2.cpp
...
${OBJECTDIR}/src/TLUAScript.o: src/TLUAScript.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.cc) -g -D_DEBUG -Iinclude -Ideps/bullet/src -Ideps/irrlicht/include -Isource/irrlicht -Ideps/irrklang/include -Itools/lsl/include -Itools/lsl/src/lua -Ideps/irrlicht/source/Irrlicht -o ${OBJECTDIR}/src/TLUAScript.o src/TLUAScript.cpp
...
${OBJECTDIR}/tools/lsl/src/CSceneNodeAnimatorMaterialLayer.o: tools/lsl/src/CSceneNodeAnimatorMaterialLayer.cpp 
	...
	$(COMPILE.cc) -g -D_DEBUG -Iinclude -Ideps/bullet/src -Ideps/irrlicht/include -Isource/irrlicht -Ideps/irrklang/include -Itools/lsl/include -Itools/lsl/src/lua -Ideps/irrlicht/source/Irrlicht -o ${OBJECTDIR}/tools/lsl/src/CSceneNodeAnimatorMaterialLayer.o tools/lsl/src/CSceneNodeAnimatorMaterialLayer.cpp
...
${OBJECTDIR}/tools/lsl/src/clsl.o: tools/lsl/src/clsl.cpp 
	${MKDIR} -p ${OBJECTDIR}/tools/lsl/src
	$(COMPILE.cc) -g -D_DEBUG -Iinclude -Ideps/bullet/src -Ideps/irrlicht/include -Isource/irrlicht -Ideps/irrklang/include -Itools/lsl/include -Itools/lsl/src/lua -Ideps/irrlicht/source/Irrlicht -o ${OBJECTDIR}/tools/lsl/src/clsl.o tools/lsl/src/clsl.cpp
