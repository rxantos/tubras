...
#ifndef _TIRRMESHFILELOADER_H_
#define _TIRRMESHFILELOADER_H_
...
namespace Tubras
{
    ...
    class TIrrMeshFileLoader : public IMeshLoader
    {
    public:

        //! Constructor
        TIrrMeshFileLoader(scene::ISceneManager* smgr, io::IFileSystem* fs);
