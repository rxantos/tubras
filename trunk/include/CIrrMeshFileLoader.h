...
#ifndef __C_IRR_MESH_FILE_LOADER2_H_INCLUDED__
#define __C_IRR_MESH_FILE_LOADER2_H_INCLUDED__
...
private:
    ...
    //! read morph target
    void readMorphTarget(io::IXMLReader* reader, core::stringc targetName, int vertexCount, CAnimatedMeshIrr* mesh);
