...
namespace Tubras
{
    ...
    //                        T G U I S l i d e r
    //-----------------------------------------------------------------------
    TGUISlider::TGUISlider(bool horizontal, IGUIEnvironment* environment,
    ...
    bool TGUISlider::OnEvent(const SEvent& event)
    {
    ...
    void TGUISlider::updateAbsolutePosition()
    {
    ...
    s32 TGUISlider::getPosFromMousePos(s32 x, s32 y) const
    {
        if (Horizontal)
        {
    ...
    void TGUISlider::setPos(s32 pos)
    {
        if (pos < 0)
            Pos = 0;
        else if (pos > Max)
    ...
    s32 TGUISlider::getSmallStep() const
    {
        return SmallStep;
    }
    ...
    void TGUISlider::setSmallStep(s32 step)
    {
        if (step > 0)
            SmallStep = step;
        else
    ...
    //! gets the small step value
    s32 TGUISlider::getLargeStep() const
    {
        return LargeStep;
    }
    ...
    //! sets the small step value
    void TGUISlider::setLargeStep(s32 step)
    {
        if (step > 0)
            LargeStep = step;
        else
    ...
    void TGUISlider::setMax(s32 max)
    {
        if (max > 0)
            Max = max;
        else
    ...
    void TGUISlider::refreshControls()
    {
    ...
    void TGUISlider::serializeAttributes(io::IAttributes* out, io::SAttributeReadWriteOptions* options=0) const
    {
    ...
    void TGUISlider::deserializeAttributes(io::IAttributes* in, io::SAttributeReadWriteOptions* options=0)
    {
