 ...
 *  - islParser_classLayer_return      pislParser->classLayer(pislParser)
 *  - islParser_classMatrix_return      pislParser->classMatrix(pislParser)
...
typedef struct islParser_classLayer_return_struct
{
    /** Generic return elements for ANTLR3 rules that are not in tree parsers or returning trees
     */
    pANTLR3_COMMON_TOKEN    start;
    ...
    islParser_classLayer_return;

typedef struct islParser_classMatrix_return_struct
{
    /** Generic return elements for ANTLR3 rules that are not in tree parsers or returning trees
     */
    pANTLR3_COMMON_TOKEN    start;
...
struct islParser_Ctx_struct
{
    ...
    pANTLR3_PARSER   pParser;
     ...
     islParser_classLayer_return (*classLayer)	(struct islParser_Ctx_struct * ctx);
     islParser_classMatrix_return (*classMatrix)	(struct islParser_Ctx_struct * ctx);
