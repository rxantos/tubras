...
namespace irr
{
    namespace timing
    {
        ...
        {
        public:
            virtual void evaluate(const T& v0, const T& v1, T& out, const float fraction) = 0;
        };


        class CEvaluatorU8 : public IEvaluator<u8> {
        public:
            void evaluate(const u8& v0, const u8& v1, u8& out, const float fraction) {
        ...
        public:
            void evaluate(const s8& v0, const s8& v1, s8& out, const float fraction) {
        ...
        public:
            void evaluate(const u16& v0, const u16& v1, u16& out, const float fraction) {
        ...
        public:
            void evaluate(const s16& v0, const s16& v1, s16& out, const float fraction) {
        ...
        public:
            void evaluate(const u32& v0, const u32& v1, u32& out, const float fraction) {
        ...
        public:
            void evaluate(const s32& v0, const s32& v1, s32& out, const float fraction) {
        ...
        public:
            void evaluate(const f32& v0, const f32& v1, f32& out, const float fraction) {
        ...
        public:
            void evaluate(const f64& v0, const f64& v1, f64& out, const float fraction) {
        ...
        class CEvaluatorVector3df : public IEvaluator< core::vector3df > {
        public: 
            void evaluate(const core::vector3df& v0, const core::vector3df& v1,
                core::vector3d<f32>& out, const float fraction) {
                out.X = v0.X + ((v1.X - v0.X) * fraction);
                out.Y = v0.Y + ((v1.Y - v0.Y) * fraction);
        ...
        public:
            void evaluate(const core::rectf& v0, const core::rectf& v1,
                core::rectf& out, const float fraction) {
        ...
        public:
            void evaluate(const core::recti& v0, const core::recti& v1,
                core::recti& out, const float fraction) {
        ...
        public:
            void evaluate(const core::quaternion& v0, const core::quaternion& v1,
                core::quaternion& out, const float fraction) {
        ...
        public:
            void evaluate(const core::matrix4& v0, const core::matrix4& v1,
                core::matrix4& out, const float fraction) {
        ...
        public:
            void evaluate(const core::dimension2df& v0, const core::dimension2df& v1,
                core::dimension2df& out, const float fraction) {
        ...
        public:
            void evaluate(const core::dimension2di& v0, const core::dimension2di& v1,
                core::dimension2di& out, const float fraction) {
        ...
        public:
            void evaluate(const core::dimension2du& v0, const core::dimension2du& v1,
                core::dimension2du& out, const float fraction) {
