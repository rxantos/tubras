...
${OBJECTDIR}/source/Irrlicht/CIrrDeviceConsole.o: source/Irrlicht/CIrrDeviceConsole.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/Irrlicht
	$(COMPILE.cc) -g -DIRRLICHT_EXPORTS -DWIN32 -D_WINDOWS -D_DEBUG -D__GNUWIN32__ -D_IRR_COMPILE_WITH_DIRECT3D_9_ -Iinclude -Isource/Irrlicht/zlib -I${D3D9_SDK}/include -o ${OBJECTDIR}/source/Irrlicht/CIrrDeviceConsole.o source/Irrlicht/CIrrDeviceConsole.cpp
...
${OBJECTDIR}/source/Irrlicht/CPLYMeshFileLoader.o: source/Irrlicht/CPLYMeshFileLoader.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/Irrlicht
	$(COMPILE.cc) -g -DIRRLICHT_EXPORTS -DWIN32 -D_WINDOWS -D_DEBUG -D__GNUWIN32__ -D_IRR_COMPILE_WITH_DIRECT3D_9_ -Iinclude -Isource/Irrlicht/zlib -I${D3D9_SDK}/include -o ${OBJECTDIR}/source/Irrlicht/CPLYMeshFileLoader.o source/Irrlicht/CPLYMeshFileLoader.cpp
...
${OBJECTDIR}/source/Irrlicht/COBJMeshWriter.o: source/Irrlicht/COBJMeshWriter.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/Irrlicht
	$(COMPILE.cc) -g -DIRRLICHT_EXPORTS -DWIN32 -D_WINDOWS -D_DEBUG -D__GNUWIN32__ -D_IRR_COMPILE_WITH_DIRECT3D_9_ -Iinclude -Isource/Irrlicht/zlib -I${D3D9_SDK}/include -o ${OBJECTDIR}/source/Irrlicht/COBJMeshWriter.o source/Irrlicht/COBJMeshWriter.cpp
...
${OBJECTDIR}/source/Irrlicht/CPLYMeshWriter.o: source/Irrlicht/CPLYMeshWriter.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/Irrlicht
	$(COMPILE.cc) -g -DIRRLICHT_EXPORTS -DWIN32 -D_WINDOWS -D_DEBUG -D__GNUWIN32__ -D_IRR_COMPILE_WITH_DIRECT3D_9_ -Iinclude -Isource/Irrlicht/zlib -I${D3D9_SDK}/include -o ${OBJECTDIR}/source/Irrlicht/CPLYMeshWriter.o source/Irrlicht/CPLYMeshWriter.cpp
...
${OBJECTDIR}/source/Irrlicht/CImageLoaderRGB.o: source/Irrlicht/CImageLoaderRGB.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/Irrlicht
	$(COMPILE.cc) -g -DIRRLICHT_EXPORTS -DWIN32 -D_WINDOWS -D_DEBUG -D__GNUWIN32__ -D_IRR_COMPILE_WITH_DIRECT3D_9_ -Iinclude -Isource/Irrlicht/zlib -I${D3D9_SDK}/include -o ${OBJECTDIR}/source/Irrlicht/CImageLoaderRGB.o source/Irrlicht/CImageLoaderRGB.cpp
