...
namespace Tubras
{
    ...
    typedef TArray<TString> vector_string;
    ...
    public:
        ...
        private:
            typedef TArray<class TFile> Files;
            Files _files;
        };
    ...
    private:
        typedef TArray<class TFile> Directories;
    ...
    {
        assert(n >= 0 && n < (int)_filename.size());
        return _filename[n];
    }
    ...
    {
        return _filename.subString(0, (s32)_dirname_end);
    }
    ...
    {
        return _filename.subString((u32)_basename_start,_filename.size());
    }
    ...
    {
        return _filename.subString(0, (s32)_basename_end);
    }
    ...
    {
        return _filename.subString((u32)_basename_start, (s32)(_basename_end - _basename_start));
    }
    ...
    {
        if (_extension_start == NPOS) 
        {
            return TString();
        } else 
        {
            return _filename.subString((u32)_extension_start,_filename.size());
        }
    }
    ...
    {
        return !_filename.size() || _filename[0] != '/';
    }
