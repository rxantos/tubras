...
${OBJECTDIR}/src/TObject.o: src/TObject.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.cc) -O2 -s -DWIN32 -DNDEBUG -D_LIB -D_IRR_STATIC_LIB_ -DSTATIC_LINKED -D__GNUWIN32__ -Iinclude -Ideps/bullet/src -Ideps/irrlicht/include -Isource/irrlicht -Ideps/irrklang/include -Itools/lsl/include -Itools/lsl/src/lua -Ideps/irrlicht/source/Irrlicht -Ideps/particle2/Particle2/Particle -Ideps/particle2/Particle2/ParticleLib -o ${OBJECTDIR}/src/TObject.o src/TObject.cpp
...
${OBJECTDIR}/src/TGUISkin2.o: src/TGUISkin2.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.cc) -O2 -s -DWIN32 -DNDEBUG -D_LIB -D_IRR_STATIC_LIB_ -DSTATIC_LINKED -D__GNUWIN32__ -Iinclude -Ideps/bullet/src -Ideps/irrlicht/include -Isource/irrlicht -Ideps/irrklang/include -Itools/lsl/include -Itools/lsl/src/lua -Ideps/irrlicht/source/Irrlicht -Ideps/particle2/Particle2/Particle -Ideps/particle2/Particle2/ParticleLib -o ${OBJECTDIR}/src/TGUISkin2.o src/TGUISkin2.cpp
...
${OBJECTDIR}/src/lua/lua.o: src/lua/lua.c 
	${MKDIR} -p ${OBJECTDIR}/src/lua
	$(COMPILE.c) -O2 -s -o ${OBJECTDIR}/src/lua/lua.o src/lua/lua.c
