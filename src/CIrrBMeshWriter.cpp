...
core::stringw CIrrBMeshWriter::getVectorAsStringLine(const core::vector3df& v) const
{
	core::stringw str;
...
core::stringw CIrrBMeshWriter::getVectorAsStringLine(const core::vector2df& v) const
{
	core::stringw str;
